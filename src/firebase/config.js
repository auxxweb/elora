...
export const app = hasFirebaseEnv ? initializeApp(firebaseConfig) : null
export const auth = app ? getAuth(app) : null
export const db = app ? getFirestore(app) : null
export const storage = app ? getStorage(app) : null

export const firebaseSetupMessage =
  'Firebase is not configured yet. Add your VITE_FIREBASE_* values to a local .env file before using data, auth, or uploads.'
